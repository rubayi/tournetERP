 ...
 *
 * @author : rubayi
 * @fileName : ExportListPdfReportGenerator
 * @since : 2024-05-10
 */
@Service
public class ExportListPdfReportGenerator extends AbstractReportGenerator<Company> {
    private static final String PDF_TEMPLATE = "trafficmemologsearchReport.jasper";
    protected static final String REPORT_NAME = "trafficmemologsearchReport";
