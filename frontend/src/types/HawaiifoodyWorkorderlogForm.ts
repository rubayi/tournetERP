...
import { getDateMemberValue } from "@/utils/helpers/ConstructorHelper";

export interface IHawaiifoodyWorkorderlogForm {
  worknum: number | null;
...
export class HawaiifoodyWorkorderlogForm implements IHawaiifoodyWorkorderlogForm {
  ...
  constructor(obj?: IHawaiifoodyWorkorderlogForm) {
