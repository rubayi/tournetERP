...
export interface ITournetWorkorderlogForm {
  worknum: number | null;
...
export class TournetWorkorderlogForm implements ITournetWorkorderlogForm {
  ...
  constructor(obj?: ITournetWorkorderlogForm) {
